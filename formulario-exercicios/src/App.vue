		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Características do Problema">
					<span class="mr-4"><input type="checkbox" value="reproduzivel" v-model="checkedProblem"> Reproduzível</span>
					<span><input type="checkbox" value="intermitente" v-model="checkedProblem"> Intermitente</span>
				</Rotulo>
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridade">
						<option v-for="prioridade in prioridades" 
							...
							:selected="prioridade.codigo === 3">{{prioridade.codigo}} - {{prioridade.nome}}</option>
					</select>
				</Rotulo>
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Marque as Opções">
					<span>
						<ul>
							<li v-for="c in checkedProblem" :key="c">{{ c }}</li>
						</ul>
					</span>
				</Rotulo>
				<Rotulo nome="Qual produto?">
